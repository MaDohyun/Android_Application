            ...
            for (int i = 0; i < permissions.length; i++) {
                if (Manifest.permission.ACCESS_FINE_LOCATION.equals(permissions[i])) {
                    if (grantResults[i] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        builder.setTitle("Location permissions are turned off");
                        builder.setMessage("The settings must allow location permissions");
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                try {
                                    ...
                                    rae.startResolutionForResult(LocationActivity.this, GPS_UTIL_LOCATION_RESOLUTION_REQUEST_CODE);
